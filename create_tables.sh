...
$ORACLE_HOME/bin/sqlplus -S prbd/prbdprbd <<SQL
whenever sqlerror exit 2;
alter session set current_schema = prbd;
show user;
CREATE SCHEMA  AUTHORIZATION prbd; 
ALTER SESSION SET CURRENT_SCHEMA = prbd;
show user;
SELECT * FROM all_users;
select * from dba_objects where object_name = 'prbd'
...
CREATE TABLE PEDIDOANULADO (
  ...
  FECHACIERRE    TIMESTAMP          NOT NULL,
  FECHAANULACION TIMESTAMP          NOT NULL,
