...
( echo ; echo ; echo prbd ; echo prbd ; echo n ) | sudo AWK='/usr/bin/awk' /etc/init.d/oracle-xe configure

"$ORACLE_HOME/bin/sqlplus" -L -S / AS SYSDBA <<SQL
CREATE USER prbd IDENTIFIED BY prbdprbd;
GRANT CONNECT, RESOURCE TO prbd;
GRANT EXECUTE ON SYS.DBMS_LOCK TO prbd;
SQL
